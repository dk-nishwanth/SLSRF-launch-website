    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden pt-20">
      ...
      <div className="relative z-20 w-full max-w-[1400px] px-10">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {/* Scroll CTA */}
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-opacity duration-700 cursor-pointer group">

...
const Frontier: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-black px-4 sm:px-6 md:px-12">
            ...
            <div className="relative aspect-[16/10] overflow-hidden rounded-sm group shadow-[0_0_50px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-full px-4 sm:px-8 flex justify-center">
                  <h3
                    className="text-white text-[14vw] sm:text-[11vw] md:text-[9vw] lg:text-[7vw] xl:text-[5.5vw] font-black uppercase tracking-tighter leading-none select-none"
                    style={{
                      textShadow:
